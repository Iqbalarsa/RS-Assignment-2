...
class SASRec(torch.nn.Module):
    ...
    def log2feats(self, log_seqs):
        # Convert input sequence to tensor on correct device
        ...
        # Position ids: padding positions stay 0
        ...
        # Padding mask: ignore padded tokens (0)
        padding_mask = (log_seqs == 0)

        for i in range(len(self.attention_layers)):
            # MultiheadAttention expects shape (T, B, C)
    ...
    def predict(self, user_ids, log_seqs, item_indices):
        ...
        # Use the last position representation for next-item prediction
